...
const variantStyles: Record<TypographyVariant, string> = {
  "visuelt-bold-48":
    "text-[48px] leading-[120%] font-[family-name:Visuelt] font-bold",
  "visuelt-bold-32":
    "text-[32px] leading-[120%] font-[family-name:Visuelt] font-bold",
  "poppins-md-16": "text-[16px] leading-[20px] var(--font-poppins) font-medium",
  "poppins-reg-14":
    "text-[14px] leading-[20px] var(--font-poppins) font-normal",
};
